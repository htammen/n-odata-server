...
module.exports = function (loopbackApplication, options) {
	...
	oDataGet.setConfig(oDataServerConfig);
...
function _handleDelete(req, res) {
	...
	oDataDelete.handleDelete(req, res);
}
