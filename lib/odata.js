...
var OData = (function () {
                ...
                common.getRequestModelClass(_this.oLoopbackApp.models, req.params[0]).then(function (modelClassResult) {
                    ...
                    if (ctx && ctx.method && ctx.instance) {
                        if (ctx.method.ctor.checkAccess) {
                            _this.getAccessTokenInstance(req, res).then(function () {
    ...
    OData.prototype.getAccessTokenInstance = function (req, res) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var sAccessToken;
            if (typeof req.headers["authorization"] !== "undefined") {
                ...
                var err = new Error("The request not have an accessToken - model: " + req.params[0] + ".");
                err.statusCode = 401;
                reject(err);
            }
            _this.oLoopbackApp.models.AccessToken.findById(sAccessToken, {}, function (err, instance) {
                if (!err) {
